"""
Execution Budget Policy — Phase 2 (SGK-2026-0311), Phase 5 (SGK-2026-0314 LB-4).
...
Thread-safety: Phase 5 LB-4 added threading.Lock to consume()/get_usage().
"""
...
class ExecutionBudgetPolicy:
    ...
    def __init__(
        ...
        self._lock = threading.Lock()  # Phase 5 LB-4: thread-safety

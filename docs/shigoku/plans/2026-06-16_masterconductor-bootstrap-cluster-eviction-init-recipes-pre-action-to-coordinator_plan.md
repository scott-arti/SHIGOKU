...
title: 'MasterConductor bootstrap cluster eviction: __init__/recipes/pre_action to
  coordinator'
...
# 実装計画書：MasterConductor bootstrap cluster eviction: __init__/recipes/pre_action to coordinator
